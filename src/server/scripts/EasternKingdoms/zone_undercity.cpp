...
#define GOSSIP_TEXT_EMOTE_INTRO	    "Lady Sylvanas Windrunner looks down at the discarded necklace. In her sadness, the lady incants a glamour, which beckons forth Highborne spirits. The chamber resonates with their ancient song about the Sin'dorei...."
...
public:
    ...
    bool OnQuestReward(Player* player, Creature* creature, const Quest *_Quest, uint32 /*slot*/) override
    {
        if (_Quest->GetQuestId() == QUEST_JOURNEY_TO_UNDERCITY)
        {
            ...
            CAST_AI(npc_lady_sylvanas_windrunner::npc_lady_sylvanas_windrunnerAI, creature->AI())->_player = player;
            creature->CastSpell(creature, SPELL_SYLVANAS_CAST, false);

	    creature->TextEmote(GOSSIP_TEXT_EMOTE_INTRO, nullptr, false);
    ...
    struct npc_lady_sylvanas_windrunnerAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            if (LamentEvent)
            {
			    ...
			    std::stringstream ss;
			    ss << "That could have gone better ";
			    ss << _player->GetName();
			    ss << ", come here, please. I have something I need you to take care of for me.";
			    sunsorrow->Whisper(ss.str(), LANG_UNIVERSAL,  _player);
                        }
                        flag = true;
                    }
